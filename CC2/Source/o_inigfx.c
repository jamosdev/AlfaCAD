...
#define FILENAME_INI "GFXCNF.INI"
#define FILENAME_NEW "GFXCNF.$NI"
...
BOOL Get_Private_Profile_Strings_GFX(T_Fstring lpApplicationName, BOOL (*f)(T_Fstring, T_Fstring))
/*----------------------------------------------------------------------------------------------*/
{
  int buf_len;
  FILE *stru_ini; 
...
BOOL Add_Private_Profile_Group_GFX(T_Fstring lpApplicationName, BOOL (*add_value)(FILE *stru) )
/*--------------------------------------------------------------------------------------*/
{
  int buf_len;
...
get_buf_contents (T_Fstring buf, T_Fstring *applicatin_name, T_Fstring *key_name, T_Fstring *ret_string)
/*----------------------------------------------------------------------------------------------------*/
{
